/*
  Example of overloading the plus (+) operator as a class member function
*/
#include <iostream>
...
int main(){
  ...
  /*
    ...
    fraction1.operator=(fraction2.operator+(fraction3))
  */
  ...
  */
  ...
  /*
    Next line will not compile, because class member functions
    can only work when left operand is an object of that class.
    error: no match for 'operator+' in '5 + fraction2'
  */
  // fraction1 = 5 + fraction2; 

  fraction1.print(); // 37/7
  cout<<endl;
  fraction2.print(); // 2/7
  cout<<endl;
